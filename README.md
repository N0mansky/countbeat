...
`${GOPATH}/src/github.com/n0mansky/countbeat`
...
```
git remote set-url origin https://github.com/n0mansky/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/n0mansky/countbeat
git clone https://github.com/n0mansky/countbeat ${GOPATH}/src/github.com/n0mansky/countbeat
```
